...
{% include figure.liquid path="assets/img/Baszucki.png" class="img-fluid rounded" width="100%"%}

{% include figure.liquid path="assets/img/milken.png" class="img-fluid rounded" width="100%"%}
