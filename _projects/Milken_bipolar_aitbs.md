...
{% include figure.liquid path="assets/img/bipolar_demographics_presentation.png" class="img-fluid rounded" width="100%" caption="Bipolar Disorder Patient Demographics an Clinical Characterictics" %}
...
{% include figure.liquid path="assets/img/Baszucki.png" class="img-fluid rounded" width="33%"%}

{% include figure.liquid path="assets/img/milken.png" class="img-fluid rounded" width="33%"%}
